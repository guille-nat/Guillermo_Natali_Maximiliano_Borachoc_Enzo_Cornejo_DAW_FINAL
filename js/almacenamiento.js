...
function guardarResultadoPartida() {
  ...
  ordenarRankingPorPuntaje(ranking);
...
function asignarEventosRanking() {
  ...
  document.getElementById(ID_BOTON_CERRAR_RANKING).addEventListener("click", function () {
  ...
  document.getElementById(ID_BOTON_CANCELAR_BORRADO_RANKING).addEventListener("click", function () {
    ocultarModalPorId(ID_MODAL_CONFIRMAR_RANKING);
  });
